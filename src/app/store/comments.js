...
export const loadCommentsList = (hotelId) => async(dispatch) => {
    dispatch(requested());
    try {
        const { content } = await commentService.get(hotelId);
...
export const createComment = ({ data, hotelId, currentUserId }) => async(dispatch) => {
